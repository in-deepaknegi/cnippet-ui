        ...
        <section className="relative isolate h-screen overflow-hidden bg-white">
            <div className="relative isolate h-full w-full max-w-full">
                <div className="mx-auto max-w-7xl px-6 py-4 lg:px-8">
                    <div className="mx-auto gap-0 gap-x-8 lg:mx-0 md:flex lg:max-w-none">
                        <div className="mt-20 w-full max-w-full lg:max-w-xl lg:flex-shrink-0">
                            <h1 className="text-5xl font-semibold text-black md:text-6xl">
                                Improve your creativity with our advanced materials.
                            </h1>
                            ...
                            <div className="mt-10 flex flex-col items-center gap-x-6 gap-y-4 sm:flex-row sm:gap-y-0">
                        ...
                        <div className="mt-10 hidden md:flex w-full justify-end sm:justify-start sm:gap-8 md:mt-16 lg:gap-6 xl:mt-0 translate-x-16 lg:translate-x-0">
                            <div className="hidden w-1/2 flex-none pt-0 md:block lg:w-1/2 pt-20">
